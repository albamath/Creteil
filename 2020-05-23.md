...
![Dessins pour comprendre le tore plat par Lelièvre et Goujard](img/tore-lelievre-goujard.png){width=100%}

-----------------------------------------------------------------------------------

### Quelques exemples de tores

![Tores topologiques](img/quatre-tores.png){width=80%}
...
J'aimerais rejoindre l'équipe d'analyse harmonique où l'on mélange analyse, probabilités, fractals... et collaborer par exemple avec Jaffard, Sester, Seuret, Host, autour de ces thèmes et de la dynamique symbolique.

J'aimerais mieux y découvrir l'analyse multifractale, ses applications et interactions avec les systèmes dynamiques.
J'ai constaté la forte présence du LAMA dans la communauté:
GDR AMF, écoles à Porquerolles, séminaires SCAM et COOL.

J'y continuerai à faire de la dynamique, et je me réjouis déjà des collaborations possibles avec les membres de l'équipe et plus largement du laboratoire, par exemple Brémont en probabilités et Kloeckner en géométrie.
...
![Médiation scientifique](img/quatre-images-mediation.png){width=90%}
